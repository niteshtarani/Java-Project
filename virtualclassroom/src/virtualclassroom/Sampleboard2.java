...
import javax.swing.*;
	...
	public class Sampleboard2 extends JFrame
	{
	        ...
	        public Sampleboard2()
	        {
	            ...
	            brushBut = makeMeButtons("./src/icon images/brush.jpg", 1);
	            lineBut = makeMeButtons("./src/icon images/line.png", 2);
	            ellipseBut = makeMeButtons("./src/icon images/ellipse.jpg", 3);
	            rectBut = makeMeButtons("./src/icon images/rectangle.gif", 4);

	            // Make all the buttons in makeMeColorButton by passing the
	            // button icon and true for stroke color or false for fill

	            strokeBut = makeMeColorButton("./src/icon images/stroke.jpg", 5, true);
	            fillBut = makeMeColorButton("./src/icon images/fill.png", 6, false);
